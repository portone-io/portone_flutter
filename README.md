...
## 버전정보
최신버전은 [v1.0.0-beta.1](https://github.com/portone-io/portone_flutter/tree/v1.0.0-beta.1) 입니다. 버전 히스토리는 [버전정보](CHANGELOG.md)를 참고하세요.

## 지원정보
포트원 V1/V2 플러터 모듈은 일반/정기결제 및 휴대폰 본인인증 기능을 지원합니다. 결제 모듈이 지원하는 PG사 및 결제수단에 대한 자세한 내용은 [지원정보](SUPPORT.md)를 참고해주세요.

## 설치하기
`pubspec.yaml` 파일에 `portone_flutter` 모듈을 추가해 귀하의 프로젝트에 포트원 플러터 모듈을 설치할 수 있습니다.

```
dependencies:
  portone_flutter: ^1.0.0-beta.1
```
...
import 'package:portone_flutter/v1/model/url_data.dart'; // UrlData import 추가
...
## 예제
포트원 V1/V2 플러터 모듈로 아래와 같이 일반/정기결제 및 휴대폰 본인인증 기능을 구현할 수 있습니다. 보다 자세한 내용은 [예제](example/README.md)를 참고하세요.
