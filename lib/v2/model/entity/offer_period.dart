...
sealed class OfferPeriod {
  ...
  static OfferPeriod fromJson(Map<String, dynamic> json) {
    if (json.containsKey('range')) return OfferPeriodRange.fromJson(json);
    if (json.containsKey('interval')) return OfferPeriodInterval.fromJson(json);
    throw ArgumentError('Unknown OfferPeriod variant');
  }
}

/// **기간 범위**
class OfferPeriodRange extends OfferPeriod {
  final OfferPeriodRange? range;
  OfferPeriodRange(this.range);
  static OfferPeriodRange fromJson(Map<String, dynamic> json) =>
      OfferPeriodRange(
        json['range'] != null ? OfferPeriodRange.fromJson(json['range']) : null,
      );
  @override
...
class OfferPeriodInterval extends OfferPeriod {
  ...
  static OfferPeriodInterval fromJson(Map<String, dynamic> json) =>
      OfferPeriodInterval(json['interval'] as String?);
  @override
