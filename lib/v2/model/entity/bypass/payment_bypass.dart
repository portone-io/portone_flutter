...
class PaymentBypass {
  ...
  static PaymentBypass fromJson(Map<String, dynamic> json) => PaymentBypass(
    tosspayments:
        json['tosspayments'] != null
            ? TosspaymentsPaymentBypass.fromJson(json['tosspayments'])
            : null,
    niceV2:
        json['nice_v2'] != null
            ? NiceV2PaymentBypass.fromJson(json['nice_v2'])
            : null,
    paypalV2:
        json['paypal_v2'] != null
            ? PaypalV2PaymentBypass.fromJson(json['paypal_v2'])
            : null,
    inicisV2:
        json['inicis_v2'] != null
            ? InicisV2Bypass.fromJson(json['inicis_v2'])
            : null,
    kcpV2: json['kcp_v2'] != null ? KcpV2Bypass.fromJson(json['kcp_v2']) : null,
    smartroV2:
        json['smartro_v2'] != null
            ? SmartroV2PaymentBypass.fromJson(json['smartro_v2'])
            : null,
    ksnet:
        json['ksnet'] != null
            ? KsnetPaymentBypass.fromJson(json['ksnet'])
            : null,
    welcome:
        json['welcome'] != null
            ? WelcomePaymentBypass.fromJson(json['welcome'])
            : null,
    kpn: json['kpn'] != null ? KpnBypass.fromJson(json['kpn']) : null,
    naverpay:
        json['naverpay'] != null
            ? NaverpayPaymentBypass.fromJson(json['naverpay'])
            : null,
    kakaopay:
        json['kakaopay'] != null
    ...
    tosspayV2:
        json['tosspay_v2'] != null
            ? TosspayV2PaymentBypass.fromJson(json['tosspay_v2'])
            : null,
    tossBrandpay:
        json['toss_brandpay'] != null
            ? TossBrandpayPaymentBypass.fromJson(json['toss_brandpay'])
            : null,
    hyphen:
        json['hyphen'] != null ? HyphenBypass.fromJson(json['hyphen']) : null,
    eximbayV2:
        json['eximbay_v2'] != null
            ? EximbayV2Bypass.fromJson(json['eximbay_v2'])
            : null,
    galaxia:
        json['galaxia'] != null
            ? GalaxiaPaymentBypass.fromJson(json['galaxia'])
            : null,
    inicisJp:
        json['inicis_jp'] != null
            ? InicisJpBypass.fromJson(json['inicis_jp'])
            : null,
    payletterGlobal:
        json['payletter_global'] != null
            ? PayletterGlobalBypass.fromJson(json['payletter_global'])
            : null,
    mobiliansV2:
        json['mobilians_v2'] != null
            ? MobiliansV2Bypass.fromJson(json['mobilians_v2'])
            : null,
    tripleA:
        json['triple_a'] != null
            ? TripleABypass.fromJson(json['triple_a'])
            : null,
  );
}
