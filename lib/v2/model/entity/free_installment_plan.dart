...
import 'package:portone_flutter/v2/model/entity/free_installment_plan_pg_provider.dart';
...
class FreeInstallmentPlan {
  /// 카드 결제시 사용되는 카드사 코드
  final CardCompany cardCompany;

  /// **무이자 할부를 적용할 PG사 구분코드**
  final FreeInstallmentPlanPgProvider? pgProvider;
