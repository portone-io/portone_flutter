...
class IssueBillingKeyAndPayRequest {
  ...
  static IssueBillingKeyAndPayRequest fromJson(
    ...
    billingKeyAndPayMethod: BillingKeyAndPayMethod.fromJson(
      json['billingKeyAndPayMethod'],
    ),
    ...
    bypass:
        json['bypass'] != null
            ? IssueBillingKeyAndPayBypass.fromJson(json['bypass'])
            : null,
    popup: json['popup'] != null ? Popup.fromJson(json['popup']) : null,
    iframe: json['iframe'] != null ? Iframe.fromJson(json['iframe']) : null,
    mobile:
        json['mobile'] != null
            ? IssueBillingKeyAndPayRequestUnionMobile.fromJson(json['mobile'])
            : null,
  );
}
