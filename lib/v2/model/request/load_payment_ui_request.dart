...
class LoadPaymentUIRequest {
  ...
  static LoadPaymentUIRequest fromJson(
    Map<String, dynamic> json,
  ) => LoadPaymentUIRequest(
    uiType: PaymentUIType.fromJson(json['uiType']),
    ...
    bypass:
        json['bypass'] != null
            ? LoadPaymentUIBypass.fromJson(json['bypass'])
            : null,
    ...
    shippingAddress:
        json['shippingAddress'] != null
            ...
            : null,
    promotionGroupId: json['promotionGroupId'] as String?,
    promotionIds: (json['promotionIds'] as List?)?.cast<String>(),
  );
}
