...
- [#180](https://github.com/portone-io/portone_flutter/pull/180) [`c51270e`](https://github.com/portone-io/portone_flutter/commit/c51270e65a1de6c82ea94ede60417f6d70644262) Thanks [@CirnoV](https://github.com/CirnoV)! - V2 결제/본인인증 웹뷰에서 외부 앱(카드사·ISP 등)이 실행되지 않던 문제를 수정합니다.
...
- [#168](https://github.com/portone-io/portone_flutter/pull/168) [`f104edc`](https://github.com/portone-io/portone_flutter/commit/f104edc3552d8ec5a8fd051b876266022cc127de) Thanks [@CirnoV](https://github.com/CirnoV)! - `@portone/browser-sdk` v0.1.7 릴리즈에 따라 타입을 동기화합니다.

- [#169](https://github.com/portone-io/portone_flutter/pull/169) [`d7e12b2`](https://github.com/portone-io/portone_flutter/commit/d7e12b2c0dde2918e2543ea133f0572c598a406a) Thanks [@CirnoV](https://github.com/CirnoV)! - 배포 자동화 설정을 추가하고, Flutter 및 Dart 개발 환경 설정을 최신화했습니다.

  Android Jetifier를 비활성화하고 불필요한 예제 앱 의존성을 제거했으며, Dart 포맷 및 자동 수정 사항을 적용했습니다.

## [1.0.1](https://github.com/portone-io/portone_flutter/tree/v1.0.1)
